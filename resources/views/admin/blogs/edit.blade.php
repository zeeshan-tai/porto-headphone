...
<main class="h-full pb-16 overflow-y-auto">
    ...
    <div class="container px-6 mx-auto grid">
        <label class="block text-sm">
            ...
            placeholder="Title" value="{{ $blogs->title }}">
        <br>
        </label>
        {{-- <label class="block text-sm">
            ...
            placeholder="Slug" value="{{ $blogs->slug }}">
        <br>
        </label> --}}
        <label class="block text-sm">
            ...
            placeholder="Thumbnail Image" value="{{ $blogs->thumbnail_image }}">
        <br>
        </label>
        <label class="block text-sm">
            ...
            placeholder="Cover Image" value="{{ $blogs->cover_image }}">
        <br>
        </label>
        <label class="block text-sm">
            ...
            placeholder="Short Description" value="{{ $blogs->short_description }}">
        <br>
        </label>
        <label class="block text-sm">
            ...
            placeholder="Description" value="{{ $blogs->description }}"></textarea>
        <br>
        </label>
        {{-- <label class="block text-sm">
