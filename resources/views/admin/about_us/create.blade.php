...
<main class="h-full pb-16 overflow-y-auto">
    ...
    <div class="container px-6 mx-auto grid">
        <label class="block text-sm">
            ...
            <input type="title" name="title" id="Title" value="{{ $record->title ?? '' }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            placeholder="Title">
        <br>
        </label>
        <label class="block text-sm">
        ...
        <label class="block text-sm">
            ...
            <textarea name="content" id="content" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
