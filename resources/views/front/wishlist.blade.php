            ...
            <table class="table table-wishlist mb-0">
                ...
                <tbody>
                    <tr class="product-row">
                        <td>
                            <figure class="product-image-container">
                                ...
                                <a href="{{ route('front.singleproduct') }}" class="product-image">
                        ...
                        <td>
                            <h5 class="product-title">
                                <a href="{{ route('front.singleproduct') }}">Men Watch</a>
                            </h5>
                        </td>
                    ...
                    <tr class="product-row">
                        ...
                        <td>
                            <h5 class="product-title">
                                <a href="{{ route('front.singleproduct') }}">Men Cap</a>
                            </h5>
                        </td>
                        <td class="price-box">$17.90</td>
                        <td>
                        ...
                        <td class="action">
                            <a href="ajax/product-quick-view.html" class="btn btn-quickview mt-1 mt-md-0"
                                title="Quick View">Quick
                                View</a>
                            <a href="{{ route('front.singleproduct') }}" class="btn btn-dark btn-add-cart btn-shop">
                                SELECT OPTION
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr class="product-row">
                        ...
                        <td>
                            <h5 class="product-title">
                                <a href="{{ route('front.singleproduct') }}">Men Black Gentle Belt</a>
                            </h5>
                        </td>
                        <td class="price-box">$17.90</td>
                        <td>
