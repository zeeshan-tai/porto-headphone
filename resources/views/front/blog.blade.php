                ...
                <div class="blog-section row">
                    <div class="col-md-6 col-lg-4">
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="{{ route('front.single') }}">
                                    <img src="{{asset('uploads/').'/'.$blog->cover_image}}" alt="cover_image" width="225"
                                        height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">{{ \Carbon\Carbon::now()->format('d') }}</span>
                                    <span class="month">{{ \Carbon\Carbon::now()->format('M') }}</span>
                                </div>
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="{{ route('front.single') }}">{{ $blog->title }}</a>
                                </h2>
                                <div class="post-content">
                                    <p>{{$blog->short_description}}</p>
                                </div><!-- End .post-content -->
                                <a href="{{ route('front.single') }}" class="post-comment">0 Comments</a>
                            </div><!-- End .post-body -->
                        </article><!-- End .post -->
                         @endforeach
                    </div>
                    ...
                    {{-- <div class="col-md-6 col-lg-4">
                        <article class="post">
                            <div class="post-media">
                                <a href="{{ route('front.single') }}">
                                    <img src="{{asset('uploads/').'/'.$blog->cover_image}}" alt="Post" width="225"
                                        height="280">
                                </a>
                                <div class="post-date">
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="{{ route('front.single') }}">Fashion Trends</a>
                                </h2>
                                <div class="post-content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <article class="post">
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="{{ route('front.single') }}">Etiam laoreet sem</a>
                                </h2>
                                <div class="post-content">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras non
                                        placerat mi.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <article class="post">
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="{{ route('front.single') }}">Perfect Accessories</a>
                                </h2>
                                <div class="post-content">
                    ...
                    <div class="widget widget-post">
                        ...
                        <ul class="simple-post-list">
                            <li>
                                ...
                                <div class="post-info">
                                    <a href="{{ route('front.single') }}">Top New Collection</a>
